...
var pcscore =0;
var ball = {
    x:350/2, y:480/2, r:20, dx:3, dy:3  }
rightWristY =  rightWristX = 0; scoreRightWrist = 0; game_status = "";
function setup(){
...
function move(){
  ...
  if (ball.y >= paddle1Y&& ball.y <= paddle1Y + paddle1Height) {
    ...
    pcscore++; missed.play(); reset(); navigator.vibrate(100);}}
if(pcscore ==4){
    fill("#FFA500");
    stroke(0)
